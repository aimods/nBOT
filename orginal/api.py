...
# SMS pin to mobile using Clickatel
...
class LineAPI(object):
    ...
    """
    LINE_DOMAIN = "http://gd2.line.naver.jp:443"

    LINE_HTTP_URL          = LINE_DOMAIN + "/api/v4/TalkService.do"
    LINE_HTTP_IN_URL       = LINE_DOMAIN + "/S4"
    ...
    def login(self):
        ...
        if msg.type == 1:
            ...
            pinmsg = "Enter PinCode '%s' to your mobile phone in 2 minutes" % self._pinCode
            # Send SMS

            # clickatell = Http('aimods-linebot','8oojkiyd','3261208')
            # cRep = clickatell.sendMessage(['66899366699'], pinmsg)
